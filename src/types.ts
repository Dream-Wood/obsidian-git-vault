...
declare module "obsidian" {
    ...
    interface Workspace {
        ...
        /**
         * Emitted when the sync backend provider changes; `provider` is the new
         * active sync provider key.
         */
        on(
            name: "obsidian-git:sync-provider-changed",
            callback: (provider: SyncProviderSetting) => void,
            ctx?: unknown
        ): EventRef;
